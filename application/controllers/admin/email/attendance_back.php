...
$header = '<img src="'.base_url().'assets/images/logo.png" height="100px">
        <h3>'.get_user_username($this->input->post('employee_id')).' 您好：</h3>
...
<table style="width:100%;background:#fafaf8;padding:15px;">
    ...
    <tr>
        <td>
            審核狀態 : <span style="color: #82b440;">已審核通過</span>
        </td>
    </tr>
</table>';
...
$message .= '<tr>
                <td text-align="center">
                    <a href="'.base_url().'attendance/view/'.$id.'" target="_blank" class="order-check-btn">查看</a>
                </td>
            </tr>';
$message .= '</table>';
