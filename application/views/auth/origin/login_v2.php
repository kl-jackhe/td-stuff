    ...
    <div class="container-fluid">
        ...
        <content id="content">
            <div class="row justify-content-center">
                <div class="col-12" style="background-color:#f2efe8; padding-top: 80px;padding-bottom: 80px;">
                </div>
                <div class="col-12" style="padding-top: 80px;">
                    <div class="row justify-content-center" style="position: relative; top: -40%;">
                        <div class="col-md-4 col-sm-6" style="background-color: #fff;border: 0.5px solid #615d56; padding: 40px;color: #615d56;">
                            <h4><?=get_setting_general('name')?> 商店登入</h4>
                            ...
                            <?php echo form_open('login', $attributes); ?>
                                ...
                                <div class="form-group" style="margin-top: 30px;">
                                    <label style="font-weight: bold;">行動電話 <span style="font-size: 14px">Phone</span></label>
                                    <input type="text" class="form-control" id="identity" name="identity" placeholder="09xxxxxxxx" required>
                                </div>
                                <div class="form-group" style="margin-top: 30px;">
                                    <label style="font-weight: bold;">密碼 <span style="font-size: 14px">Password</span></label>
                                    <input type="password" class="form-control" id="password" name="password" placeholder="6-15個字元" required>
                                </div>
                                <div class="form-group text-center mb-0" style="margin-top: 30px;">
                                    <input type="submit" value="登入" style="background-color: #615d56;color: #fff;border: 0;border-radius: 15px;padding-left: 13%;padding-right: 13%;padding-top: 3px;padding-bottom: 3px;cursor: pointer;">
                                </div>
                            <?php echo form_close(); ?>
                        </div>
                    </div>
