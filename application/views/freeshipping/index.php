...
<div role="main" class="main">
    <section class="page-header no-padding sm-slide-fix">
        <div class="row">
            <div class="owl-carousel owl-theme item-slide" data-plugin-options='{"items":1, "loop": true, "nav":true, "dots":true,"autoplay": true,"autoplayTimeout": 6000}'>
                <?php if(!empty($banner)) { foreach($banner as $data) { ?>
                <a href="<?php echo $data['banner_link'] ?>" class="banner slidebanner">
    ...
    <section class="form-section">
        <div class="container" id="main_area">
            ...
            <div class="searchbox collapse in " id="essearch">
                ...
                <?php echo form_open('freeshipping#main_area' , $attributes); ?>
                <div class="row">
            ...
            <div class="searchbox" id="store_list_area" style="margin-top: 50px; margin-bottom: 50px; padding: 30px 0px; <?php //if(!empty($this->session->userdata('delivery_place'))) {echo 'display: block;';}else{echo 'display: none;';} ?>">
                <div class="row">
                    <div class="container">
                        <div class="col-md-12">
                                                ...
                                                <?php if(!empty($store_order_time)) { foreach($store_order_time as $sot) { ?>
                                                    ...
                                                    <?php if(strtotime($sot['store_order_time'])==$date){ ?>
                                                        <?php if($sot['store_order_time']==date('Y-m-d') && strtotime(date('H:i:s'))>strtotime($sot['store_close_time'])){ $show='hide'; } else { $show='show'; } ?>
                                                            <div class="col-md-3 <?php echo $show; ?>">
                                                                <div class="col-item">
                                                                    <div class="photo">
                                                                        <a href="/store/view/<?php echo $sot['store_order_time_id'] ?>?delivery_date=<?php echo $sot['store_order_time'] ?>">
                                                                            <img src="/assets/uploads/<?php echo $sot['store_image'] ?>" class="img-responsive" alt="">
                                                                        </a>
                                                                    </div>
                                                                    <div class="info">
                                                                        <div class="row">
                                                                            <div class="col-md-12 text-center">
                                                                                <a href="/store/view/<?php echo $sot['store_order_time_id'] ?>?delivery_date=<?php echo $sot['store_order_time'] ?>" class="link">
                                                                                    <h3>
                                                                                        <?php echo $sot['store_name'] ?></a>
                                                                                    </h3>
                                                                                </a>
                                                                            </div>
                                                                        </div>
