<? if ($agentID == '' && get_setting_general('phone1') != '') { ?>
    <div id="fa-phone-square" class="my-3 icon_pointer col-4 link_href">
...
<? if ($agentID == '' && get_setting_general('email') != '') { ?>
    <div id="fa-email-square" class="my-3 icon_pointer col-4 link_href">
...
<? if ($agentID == '' && get_setting_general('official_facebook_1') != '') { ?>
    <div id="fa-facebook-square" class="my-3 icon_pointer col-4 link_href">
