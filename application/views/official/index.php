    ...
    <div class="container-fluid">
        <header id="header">
            <!-- <div class="row py-4 header_style justify-content-center header">
                ...
                <div class="col-6 col-md-8 col-lg-9" style="align-self: center;">
                    <div class="row justify-content-end">
                        <nav class="navbar navbar-expand-lg navbar-light">
                            <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarToggler" aria-controls="navbarToggler" aria-expanded="false" aria-label="Toggle navigation" style="border:none;">
                                <img src="/assets/images/559mall_official/icon/web%20icon_menu.png" style="width:40px;">
                            </button>
                            <div class="collapse navbar-collapse" id="navbarToggler">
                                <ul class="navbar-nav">
                                    ...
                                    <?php if (!$this->ion_auth->logged_in()){ ?>
                                        <li class="nav-item" style="border: 2px solid #615d56;border-radius: 30px;padding: 1px 15px 1px 15px; background-color: transparent;">
                                            <a href="#" style="color: #000;text-decoration:none;">登入</a>
                                        </li>
                                        <li class="nav-item" style="border: 2px solid #615d56;border-radius: 30px;padding: 1px 15px 1px 15px;background-color: #615d56;">
                                            <a href="#" style="color: #fff;text-decoration:none;">註冊我的店</a>
                                        </li>
                                    <? } else { ?>
                                        <li class="nav-item">
                                            <a href="/auth/edit_user">我的帳戶</a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="/logout">登出</a>
                                        </li>
            ...
            <div class="row py-4 header_style justify-content-center header">
                ...
                <div class="col-6 col-md-8 col-lg-9" style="align-self: center;">
                    <div class="row justify-content-end">
                        <div class="col-12 text-right header_pc">
                            <a href="#" class="nav_item_style">網購商店示範</a>
                            <a href="#" class="nav_item_style">商店精選</a>
                            <a href="#" class="nav_item_style">技術支援</a>
                ...
                <div class="col-12">
                    <div class="row text-center justify-content-center pb-5">
                        <div class="col-12 col-md-12 p-0">
                            <!-- <img src="/assets/images/559mall_official/index_top%20pic_1920.jpg" class="img-fluid banner d-none d-md-none d-lg-none d-xl-block">
                    ...
                    <div class="row text-center justify-content-center py-5">
                        <div class="col-12 col-md-10">
                            ...
                            <div style="background-image: url('/assets/images/559mall_official/page_2-button_bg.png'); background-position: center;background-repeat: no-repeat;background-size: auto;padding: 15px;font-size: 24px;">
        ...
        <footer id="footer">
            <div class="row justify-content-center py-5" style="background-color: #e3e1df;">
                <div class="col-12 col-md-6" style="color: #6b6b6b;font-weight: bold;">
            ...
            <div class="row justify-content-center pt-4 pb-3" style="background-color: #625d57;color: #fff;">
                <div class="col-12 col-md-8 text-center" style="font-weight: bold;letter-spacing: 2px;">
                    <div class="row justify-content-center">
                        <div class="col-6 col-md-2 my-1"><a href="#">關於559mall</a></div>
                        <div class="col-6 col-md-2 my-1"><a href="#">聯絡我們</a></div>
                        <div class="col-6 col-md-2 my-1"><a href="#">購物商店示範</a></div>
                        <div class="col-6 col-md-2 my-1"><a href="#">問與答</a></div>
                        <div class="col-6 col-md-2 my-1"><a href="#">技術支援</a></div>
                    </div>
                </div>
            </div>
            <div class="row justify-content-center pb-4" style="background-color: #625d57;color: #fff;">
                <div class="col-12 text-center">
                    <span style="letter-spacing: 2px;">
                        ｜&emsp;<a href="#">免責聲明</a>&emsp;｜&emsp;<a href="#">服務條款</a>&emsp;｜&emsp;<a href="#">知識產權</a>&emsp;｜&emsp;&emsp;Copyright © 2023 <?php echo get_setting_general('name'); ?>. All rights reserved.
                    </span>
                </div>
            </div>
        </footer>
