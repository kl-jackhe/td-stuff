  ...
  <div class="row">
    <div class="col-md-6">
      ...
      foreach ($result as $data):
        $total_sum+=(int)$data['order_total'];
      endforeach ?>
      <?php echo '查詢: '.$this->input->get('start_date').' 到 '.$this->input->get('end_date').' 的營業額: <br>'.'<h3>$'.number_format($total_sum).'</h3>'; ?>
      <?php } ?>
    </div>
        ...
        <table class="table table-striped table-bordered table-hover">
          ...
          <?php foreach ($result as $data): ?>
            <tr>
              ...
              <td><?php echo '$'.number_format($data['order_total']) ?></td>
