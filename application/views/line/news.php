...
<body>
    ...
    <script>
    window.location = '<?php echo base_url() ?>posts';        
    ...
    $(document).ready(function() {
        if (LIFF_userID != "") {
            setTimeout("get_line_id_and_login('news')", 50);
        } else {
            setTimeout("get_line_id_and_login('news')", 50);
        }
    });
    ...
    function get_line_id_and_login(url = '1', redirect = 'yes') {
        if (LIFF_userID != "") {
            ...
            //     data: 'line_id=' + LIFF_userID + '&url=news',
            ...
            setTimeout("get_line_id_and_login('news')", 300);
        }
    };
    </script>
