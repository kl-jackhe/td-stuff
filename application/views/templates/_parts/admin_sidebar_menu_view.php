    ...
    <?php if ($this->is_liqun_food || $this->is_td_stuff) : ?>
      <li <?= (($current == "product" && $sub_current != "category") || ($current == "product" && $sub_current == "category")) ? "class='active'" : ''; ?>>
        ...
        <ul class="submenu">
          ...
          <li <?= ($current == "product" && ($sub_current == "product_tag" || $sub_current == "edit_tag")) ? 'class="active"' : ''; ?>>
            <a href="/admin/product/product_tag">商品標籤</a>
          </li>
          <li <?= ($current == "product" && $sub_current != "category" && $sub_current != "product_tag" && $sub_current != "edit_tag") ? 'class="active"' : ''; ?>>
