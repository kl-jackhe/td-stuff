                            ...
                            <div id="atmpayinfo" class="atmpay">
                                <table class="table table-bordered fs-13 color-595757">
                                    <tr>
                                        ...
                                        <td><?php echo $this->session->userdata('order_number') ?></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><span><?php echo $this->session->userdata('user_phone') ?></span></td>
                                    </tr>
                                    <tr>
                                        <th style="width:50%;">備註</th>
                                        <td><?php echo $this->session->userdata('remark') ?></td>
                                    </tr>
                                </table>
                            </div>
                    ...
                    <div class="checkout-list" style="box-shadow: none; border: none;">
                        <div class="row">
                            <div class="col-md-12" style="box-shadow: 3px 3px 10px 0px grey; padding: 30px; border-left: none;">
                                <h4 class="fs-13 color-595757">訂單編號 <?php echo $this->session->userdata('order_number') ?></h4>
...
<script>
    ...
    function send_order_msg_to_line() {
