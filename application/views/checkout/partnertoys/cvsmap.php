    ...
    $excuteUrl = ($device != 'mobile') ? 'checkout/ecp_store_info/get_store_info' : 'checkout/ecp_store_info/get_store_info_location';
    ...
    try {
        ...
        $obj->Send = array(
            'MerchantID' => $self_value['MerchantID'],
            'HashKey' => $self_value['HashKey'],
            'HashIV' => $self_value['HashIV'],
