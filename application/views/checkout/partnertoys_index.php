                        ...
                        <div class="container-fluid">
                            <div class="form-group row p-3 justify-content-center" style="padding-bottom:50px !important;">
                                ...
                                <!-- <div class="input-group mb-3 col-12 col-sm-8 supermarket">
                                    ...
                                    <div style="width: 100%; margin-top: 15px;">
                                        <span class="btn btn-primary" onclick="openCvsMap();">選擇門市</span>
                                    </div>
                                </div> -->
                                <!-- 地圖 -->
...
<script>
    $("#wizard").steps({
        ...
        onStepChanging: function(event, currentIndex, newIndex) {
            ...
            if (delivery == 'ktj_delivery' || delivery == 'home_delivery') {
...
<script>
    ...
    function select_store_info() {
        ...
        if (selectedDelivery == 'family_pickup') {
            mobileMap = 'https://mfme.map.com.tw/default.aspx?eshopid=870&&servicetype=1&url=<?php echo 'https://' . $_SERVER['HTTP_HOST'] . '/get_store_info_location.php' ?>';
            pcMap = 'https://mfme.map.com.tw/default.aspx?eshopid=870&servicetype=1&url=<?php echo 'https://' . $_SERVER['HTTP_HOST'] . '/get_store_info.php' ?>';
        } else if (selectedDelivery == '711_pickup') {
            mobileMap = 'https://emap.presco.com.tw/c2cemap.ashx?eshopid=870&&servicetype=1&url=<?php echo 'https://' . $_SERVER['HTTP_HOST'] . '/get_store_info_location.php' ?>';
            pcMap = 'https://emap.presco.com.tw/c2cemap.ashx?eshopid=870&&servicetype=1&url=<?php echo 'https://' . $_SERVER['HTTP_HOST'] . '/get_store_info.php' ?>';
        }
