    ...
    <div class="container-fluid">
        ...
        <content id="content">
            <div class="row justify-content-center">
                <div class="col-12 col-md-8" style="padding-top: 100px;">
                    <h3 style="letter-spacing: 2px;display: inline-block;">程式技術支援</h3>
                </div>
                <div class="col-12 col-md-8 technical_support" style="margin-top: 30px;">
                    <div class="row justify-content-center">
                        <div class="col-12 col-md-4 mb-5">
                            <a href="#">
                                <div class="text-center" style="padding: 20px 10px 20px 10px; border: 1px solid gray; border-radius: 5px;">
                                    <img src="/assets/images/559mall_official/icon/web%20icon_support-1.png" style="width: 35%">
                                </div>
                                <p class="my-3">金流支援程式介紹、申請方式</p>
                            </a>
                        </div>
                        <div class="col-12 col-md-4 mb-5">
                            <a href="#">
                                <div class="text-center" style="padding: 20px 10px 20px 10px; border: 1px solid gray; border-radius: 5px;">
                                    <img src="/assets/images/559mall_official/icon/web%20icon_support-2.png" style="width: 35%">
                                </div>
                                <p class="my-3">金流、物流，電子發票串接方式</p>
                            </a>
                        </div>
                        <div class="col-12 col-md-4 mb-5">
                            <a href="#">
                                <div class="text-center" style="padding: 20px 10px 20px 10px; border: 1px solid gray; border-radius: 5px;">
                                    <img src="/assets/images/559mall_official/icon/web%20icon_support-3.png" style="width: 35%">
                                </div>
                                <p class="my-3">申請專屬網域名稱</p>
                            </a>
                        </div>
                        <div class="col-12 col-md-4 mb-5">
                            <a href="#">
