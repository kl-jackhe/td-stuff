    ...
    <div class="container-fluid">
        ...
        <content id="content">
            <div class="row justify-content-center">
                <div class="col-12" style="background-color:#f2efe8; padding-top: 100px;padding-bottom: 40px;">
                    <div class="row justify-content-center">
                ...
                <div class="col-12 col-md-8" style="margin-top: 50px;margin-bottom: 50px;">
                    <img src="/assets/images/559mall_official/aboutus_pic.jpg" class="img-fluid">
                </div>
            </div>
        </content>
