        ...
        <content id="content">
            <div class="row justify-content-center">
                <div class="col-10 col-sm-6 col-md-6" style="padding-top: 100px;">
                    <h3 style="letter-spacing: 2px; color: #333232;">設定方案付款</h3>
                    <h3 style="letter-spacing: 2px; color: #dd4c7c; margin-top: 30px; font-weight: 300;">選擇付款方式</h3>
                </div>
            </div>
            <div class="row justify-content-center">
                </div>
                <div class="d-none d-sm-none d-md-block d-lg-block col-md-10 text-center" style="padding-top: 30px; padding-bottom: 30px;">
                    <img src="/assets/images/559mall_official/pay%20opion_a-web.jpg" class="img-fluid">
                </div>
                <div class="col-12 d-block d-sm-block d-md-none d-lg-none text-center" style="padding-top: 30px; padding-bottom: 30px;">
                    <img src="/assets/images/559mall_official/pay opion_a-phone.jpg" alt="" class="img-fluid">
                </div>
            </div>
            <div class="row justify-content-center">
                <div class="col-8 col-sm-6 col-md-6" style="padding-top: 30px; color: #333232;">
                    <div class="form-group mb-3" style="align-items: center;">
                        <div style="padding-left: 25px; padding-bottom: 30px;">
                            <input class="form-check-input" type="radio" name="flexRadioDefault" id="flexRadioDefault1" style="cursor: pointer;">
                            <label class="form-check-label" for="flexRadioDefault1" style="cursor: pointer;">信用卡 Visa / MasterCard / JCB</label>
                        </div>
                        <div style="padding-left: 25px; padding-bottom: 30px;">
                            <input class="form-check-input" type="radio" name="flexRadioDefault" id="flexRadioDefault2" style="cursor: pointer;">
                            <label class="form-check-label" for="flexRadioDefault2" style="cursor: pointer;">行動支付 LINE PAY</label>
                        </div>
                        <div style="padding-left: 25px; padding-bottom: 30px;">
                            <input class="form-check-input" type="radio" name="flexRadioDefault" id="flexRadioDefault3" style="cursor: pointer;">
                            <label class="form-check-label" for="flexRadioDefault3" style="cursor: pointer;">行動支付 Apple Pay</label>
                        </div>
                        <div style="padding-left: 25px; padding-bottom: 30px;">
                            <input class="form-check-input" type="radio" name="flexRadioDefault" id="flexRadioDefault4" style="cursor: pointer;">
                            <label class="form-check-label" for="flexRadioDefault4" style="cursor: pointer;">銀行 / ATM 轉帳</label>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row justify-content-center pb-5">
                <div class="col-10 col-sm-6 col-md-6">
                    <div class="row justify-content-center">
                        <div class="col-7 col-sm-4 col-md-4 text-center" style="color: #fff; background-color: #615d56; margin: 25px 20px 25px 20px; border-radius: 15px; padding: 3px 0px 3px 0px;">
                            <a href="#">上一步</a>
                        </div>
                        <div class="col-7 col-sm-4 col-md-4 text-center" style="color: #fff; background-color: #615d56; margin: 25px 20px 25px 20px; border-radius: 15px; padding: 3px 0px 3px 0px;">
                            <a href="#">確定</a>
