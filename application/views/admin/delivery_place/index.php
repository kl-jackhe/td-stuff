...
<div class="row">
  <div class="col-md-6">
    <a href="/admin/delivery_place/create" class="btn btn-primary">新增取餐點</a>
  ...
  <div class="col-md-6">
    <div id="twzipcode" class="form-inline text-right">
      ...
      <!-- <span class="btn btn-primary pull-right" onclick="searchFilter()">查詢</span> -->
    </div>
