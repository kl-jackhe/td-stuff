              ...
              <div class="col-md-9">
                <div class="form-inline">
                  ...
                  foreach (explode(',', $coupon['coupon_birthday_month']) as $value) {
                    if ($value == '01') {$value_01 = true;};
                    if ($value == '02') {$value_02 = true;};
                    if ($value == '03') {$value_03 = true;};
                    if ($value == '04') {$value_04 = true;};
                    if ($value == '05') {$value_05 = true;};
                    if ($value == '06') {$value_06 = true;};
                    if ($value == '07') {$value_07 = true;};
                    if ($value == '08') {$value_08 = true;};
                    if ($value == '09') {$value_09 = true;};
                    if ($value == '10') {$value_10 = true;};
                    if ($value == '11') {$value_11 = true;};
                    if ($value == '12') {$value_12 = true;};
                  }
                  ?>
