            ...
            <div class="form-group">
              ...
              <div class="col-md-9">
                <div class="form-inline">
                  ...
                  <input type="number" class="form-control" name="use_type_number" id="use_type_number" placeholder="請輸入指定數量或價格" value="<?= $coupon['use_type_number'] ?>">
                </div>
              ...
              <div class="col-md-9">
                <div class="form-inline">
                  <select class="form-control" id="use_member_enable" name="use_member_enable" onchange="toggleMemberReadOnly()">
                    <option value="0" <?= ($coupon['use_member_enable'] == '0') ? "selected" : ""; ?>>停用</option>
                    <option value="1" <?= ($coupon['use_member_enable'] == '1') ? "selected" : ""; ?>>啟用</option>
                  </select>
                  <select class="form-control" id="use_member_type" name="use_member_type">
                    <option value="old_member" <?= ($coupon['use_member_type'] == 'old_member') ? "selected" : ""; ?>>目前有註冊的會員</option>
              ...
              <div class="col-md-9">
                <div class="form-inline">
                  <select name="use_product_enable" id="use_product_enable" class="form-control" onchange="toggleProductReadOnly()">
                    <option value="0" <?= ($coupon['use_product_enable'] == '0') ? "selected" : ""; ?>>全體</option>
                    <option value="1" <?= ($coupon['use_product_enable'] == '1') ? "selected" : ""; ?>>部分</option>
                  </select>
