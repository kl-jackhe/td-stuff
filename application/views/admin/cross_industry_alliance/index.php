<div class="row">
  <div class="col-md-6">
    <a href="/admin/cross_industry_alliance/create" class="btn btn-primary">新增合作</a>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <?php echo form_open('export/'.$this->uri->segment(1)); ?>
          ...
          <div class="form-group">
            <label for="cross_industry_alliance_birthday">起始日期:</label>
             <input type="text" class="form-control datepicker" name="start_date" id="start_date" autocomplete="off">
          </div>
          <div class="form-group">
            <label for="cross_industry_alliance_birthday">終止日期:</label>
