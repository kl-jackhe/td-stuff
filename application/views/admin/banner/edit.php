        ...
        <div class="col-md-6">
          <div class="form-horizontal">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <input type="text" class="form-control datetimepicker" name="banner_on_the_shelf" id="banner_on_the_shelf" value="<?php echo $banner['banner_on_the_shelf'] ?>" required>
              </div>
            </div>
            <div class="form-group">
              <label for="banner_off_the_shelf" class="col-sm-3 control-label">＊下架時間：</label>
              <div class="col-sm-9">
                <input type="text" class="form-control datetimepicker" name="banner_off_the_shelf" id="banner_off_the_shelf" value="<?php echo $banner['banner_off_the_shelf'] ?>" required>
              </div>
            </div>
            <div class="form-group">
