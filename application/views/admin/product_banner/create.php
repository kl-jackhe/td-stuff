<div class="row">
  ...
  <?php echo form_open('admin/product_banner/insert' , $attributes); ?>
  <div class="col-md-12">
        ...
        <div class="col-md-6">
          <div class="form-horizontal">
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <input type="text" class="form-control" name="product_banner_name" id="product_banner_name" required>
              </div>
            </div>
            <div class="form-group">
              ...
              <?php if(!empty($store)): ?>
                ...
                echo form_dropdown('product_banner_store', $data, '0', $att); ?>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <input type="text" class="form-control datetimepicker" name="product_banner_on_the_shelf" id="product_banner_on_the_shelf" required>
              </div>
            </div>
            <div class="form-group">
              <label for="product_banner_off_the_shelf" class="col-sm-3 control-label">＊下架時間：</label>
              <div class="col-sm-9">
                <input type="text" class="form-control datetimepicker" name="product_banner_off_the_shelf" id="product_banner_off_the_shelf" required>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <label class="radio-inline">
                  <input type="radio" name="product_banner_status" id="product_banner_status1" value="2"> 是
                </label>
                <label class="radio-inline">
                  <input type="radio" name="product_banner_status" id="product_banner_status2" value="1" checked> 否
                </label>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <input type="text" class="form-control" name="product_banner_link" id="product_banner_link" required>
              </div>
            </div>
            <div class="form-group">
              <label for="product_banner_sort" class="col-sm-3 control-label">＊順序：</label>
              <div class="col-sm-9">
                <input type="text" class="form-control" name="product_banner_sort" id="product_banner_sort" value="1" required>
              </div>
            </div>
            <div class="form-group">
              <label for="product_banner_content" class="col-sm-3 control-label">＊圖片：</label>
              <div class="col-sm-9">
                <img src="/assets/uploads/no-image.jpg" id="product_banner_image_preview" class="img-responsive">

                <input type="hidden" id="product_banner_image" name="product_banner_image">
