...
<div class="row">
  <div class="col-md-6">
    <a href="/admin/shop_alliance/create" class="btn btn-primary">新增合作</a>
    <!-- <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exportModal">匯出資料</button> -->
  </div>
  <div class="col-md-6">
    <div class="form-inline text-right">
      <button onclick="searchFilter()" class="btn btn-primary" style="float: right;"><i class="fa fa-search"></i> 搜尋</button>
      <input type="text" id="keywords" class="form-control" placeholder="姓名、E-mail..." onkeyup="searchFilter()"/>
      <div style="display: inline-block; float: right; width: 210px;">
        <div id="twzipcode">
          <div data-role="county" data-name="county" data-id="county"></div>
          <div data-role="district" data-name="district" data-id="district"></div>
        </div>
      </div>
