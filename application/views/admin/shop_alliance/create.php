...
<div class="row">
  ...
  <?php echo form_open('admin/shop_alliance/insert' , $attributes); ?>
  <div class="col-md-12">
        ...
        <div class="col-md-6">
          <div class="form-horizontal">
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <input type="text" class="form-control" name="shop_alliance_name" id="shop_alliance_name" required>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <div id="twzipcode" class="form-horizontal">
                  <div data-role="county" data-class="form-control"></div>
                  <div data-role="district" data-class="form-control"></div>
                  <input type="text" class="form-control" name="shop_alliance_address" id="shop_alliance_address" style="float: left; width: auto">
                </div>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <input type="text" class="form-control" name="shop_alliance_contact_name" id="shop_alliance_contact_name" required>
              </div>
            </div>
            <div class="form-group">
              <label for="shop_alliance_email" class="col-sm-3 control-label">＊E-mail：</label>
              <div class="col-sm-5">
                <input type="text" class="form-control" name="shop_alliance_email" id="shop_alliance_email" required>
              </div>
            </div>
            <div class="form-group">
              <label for="shop_alliance_phone" class="col-sm-3 control-label">＊手機：</label>
              <div class="col-sm-5">
                <input type="text" class="form-control" name="shop_alliance_phone" id="shop_alliance_phone" required>
              </div>
            </div>
          </div>
        </div>
